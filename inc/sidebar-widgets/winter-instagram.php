...
----------------------------------------*/
class winter_instagram_photo extends WP_Widget {
	public function __construct(){
		parent::__construct('winter_instagram_photo',esc_html__('[ Winter ] Intagram Photo','winter'),array(
			'description' => esc_html__('Winter Instagram Photo Widget','winter'),
		));
	}
	...
	public function form($instance){
		$title      = isset( $instance['title'] ) ? $instance['title'] : esc_html__('Instagram', 'winter');
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_user' ) ); ?>"><?php esc_html_e( 'User Name:' ,'winter'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_items' ) ); ?>"><?php esc_html_e( 'Item Number:' ,'winter'); ?></label>
...
if(!function_exists('winter_instagram_widgets')):
	function winter_instagram_widgets(){
		register_widget('winter_instagram_photo');
	}
	add_action('widgets_init','winter_instagram_widgets');
endif;
